					   				...
					   				<div class="slider-text-inner">
					   					<h1>Living &amp; Sharing the Gospel of God</h1>
											...
											<p><a class="btn btn-primary btn-demo
                                             popup-vimeo" href="https://vimeo.com/
                                             channels/staffpicks/93951774"> 
                                             <i class="icon-play4"></i> Watch Video
                                             </a> <a class="btn btn-primary btn-learn">
                                             Join us here! <i class="icon-arrow-right3"></i></a></p>
					   				</div>
				   				</div>
				   			</div>
				   		</div>
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="row">
						<div class="col-md-3 col-sm-6 col-xs-6 text-center">
							...
							<span class="fh5co-counter-label">Quotes</span>
						</div>
						<div class="col-md-3 col-sm-6 col-xs-6 text-center">
						...
						<div class="col-md-3 col-sm-6 col-xs-6 text-center">
							...
							<span class="fh5co-counter-label">Comments</span>
						</div>
					</div>
				</div>
			</div>
		...
		<input type="hidden" name="count" id="count" value="3"/>
            ...
            <div class="row">
                    <div class="col-md-4" style="text-align: center;">
                      <a id="myAnc" ><h5>Click for More</h5></a>
                    </div>
            </div>
		</div>
